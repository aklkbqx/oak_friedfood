<form action="../api/manage_user-admin.php?edit&user_id=<?= $row["user_id"] ?>" method="post" enctype="multipart/form-data" autocomplete="off">
    <div class="d-flex align-items-center justify-content-between">
        ...
        <div>
            ...
            <button type="submit" name="saveChange-account" class="btn btn-orange fs-5"><i class="fa-solid fa-floppy-disk"></i> บันทึก</button>
        </div>
    </div>
    <div class="row mt-3">
        <div class="col-4">
        ...
        <div class="col-8" style="position: relative;">
            <?php if (isset($_SESSION["user_login"])) { ?>
                <div class="d-flex">
                    <div class="d-flex p-2 px-3 rounded-3 text-white " style="background-color: #ff9841;">อีเมลของคุณ: <?= $row["email"] ?></div>
                </div>
            <?php } ?>
