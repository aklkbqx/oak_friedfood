                ...
                while ($product = $product_data->fetch()) { ?>
                            ...
                            <div style="cursor:pointer" data-bs-toggle="modal" data-bs-target="#modalProduct<?= $product["product_id"] ?>">
                                ...
                                <div style="padding: 0.8rem;">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mt-1">
                                        <div class="text-orange">ราคา <span><?= $product["price"] ?></span> บาท</div>
                                        <div class="d-flex align-items-center" style="gap:10px">
                    ...
                    <div class="modal fade" id="modalProduct<?= $product["product_id"] ?>">
                        <div class="modal-dialog modal-dialog-centered modal-xl">
                            <div class="modal-content rounded-4 shadow-lg border-2" style="border-color:var(--orange-color1)">
                                <div class="modal-body position-relative p-5">
                                    <div class="p-2 d-flex justify-content-end position-absolute bg-white rounded-circle" style="top: -20px;right:-20px;border:2px solid var(--orange-color1);border-bottom: none;border-left: none;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <div class="fs-4 d-flex mb-3 mt-3 justify-content-start text-orange" style="white-space: nowrap;gap:5px;">
                                ...
                                <div class="p-5 pt-0">
                                    <div class="d-flex align-items-center flex-row w-100 flex-sm-nowrap flex-wrap" style="gap: 10px;">
                                        ...
                                        <a href="./api/manage_carts.php?addToCart&product_id=<?= $product["product_id"] ?>&amount=1" class="w-100 addToCart">
                                            <button class="btn btn-orange w-100 rounded-4">
