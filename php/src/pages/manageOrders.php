...
<body>
    ...
    <div class="container min-width-container p-4">
        <div class="d-flex justify-content-start mb-2">
            <a href="../" class="d-flex align-items-center text-orange" style="gap:10px">
            ...
            <div class="d-flex justify-content-center">
                <ul class="m-0 p-0 list-unstyled d-flex flex-row gap-4">
                    ...
                    foreach ($ordersTabsName as $index => $tabname) { ?>
                        <a href="/pages/manageOrders.php?tabs=<?= $tabname; ?>" class="text-decoration-none text-orange fs-5 fw-medium btn rounded-3 <?= isset($_GET["tabs"]) && $_GET["tabs"] == $tabname ? "active btn-outline-orange" : "btn-light" ?>">
                            <li>
                                <?php
