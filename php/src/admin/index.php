...
<body>
    <div class="w-100 vh-100 p-4" style="min-width: 1600px;">
        <div class="bg-white rounded-4 h-100 border shadow d-flex">
            <div class="border h-100 bg-orange text-white d-flex flex-column justify-content-between p-4" style="width: 400px;border-radius: 1rem 0rem 0rem 1rem;white-space: nowrap;">
                <div>
