<div class="d-flex align-items-center justify-content-between">
    ...
    <div class="d-flex justify-content-end">
        <button class="btn btn-orange fs-4" type="button" data-bs-toggle="modal" data-bs-target="#add_product"><i class="fa-solid fa-plus"></i> เพิ่มรายการสินค้า</button>
    </div>
</div>
        ...
        <form action="../api/manage_products.php?add" method="POST" enctype="multipart/form-data" class="modal-content m-0">
                ...
                <div class="row">
                    <div class="col-lg-6 col-12" style="max-width: 558px;">
                        ...
                        <div class="d-flex align-items-center mt-3" style="gap:10px">
                            <label for="product_image" class="btn btn-orange"><i class="fa-solid fa-image"></i> เปลี่ยนรูปภาพ</label>
            ...
            <div class="modal-footer">
                <div class="d-flex align-items-center flex-row w-100" style="gap: 10px;">
                    ...
                    <button type="submit" name="add_product" class="btn btn-orange w-100">เพิ่มสินค้า</button>
                </div>
            </div>
        </form>
    </div>
                    ...
                    <div class="card-order p-0 border" style="cursor: default;height:380px !important;">
                        ...
                        <div class="p-2 pt-0">
                            ...
                            <div class="d-flex align-items-center" style="gap:10px">
                                <button class="btn btn-orange w-100" data-bs-toggle="modal" data-bs-target="#edit_product<?= $data["product_id"] ?>">
                        ...
                        <form action="../api/manage_products.php?edit&product_id=<?= $data["product_id"] ?>" method="POST" enctype="multipart/form-data" class="modal-content m-0">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-lg-6 col-12" style="max-width: 558px;">
                                        ...
                                        <div class="d-flex align-items-center mt-3" style="gap:10px">
                                            <label for="product_image<?= $data["product_id"] ?>" class="btn btn-orange"><i class="fa-solid fa-image"></i> เปลี่ยนรูปภาพ</label>
                            ...
                            <div class="modal-footer">
                                <div class="d-flex align-items-center flex-row w-100" style="gap: 10px;">
                                    ...
                                    <button type="submit" name="edit_product" class="btn btn-orange w-100">บันทึก</button>
                                </div>
                            </div>
                        </form>
                    </div>
